...
const Footer = () => {
  return (
    <section className='bg-blue-900'>
      <div className='container mx-auto border flex flex-col justify-between pl-4 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 py-20'>
        <div className='pb-8'>
        ...
        <div className='pb-8'>
          ...
          <input type="email" placeholder='Type email here' className='block bg-[#ffff] outline-none border border-gray-600 px-8 py-3 rounded-[31px] mb-4'/>
